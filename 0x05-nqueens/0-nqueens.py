#!/usr/bin/python3
"""N queens solution for the finder modules.
"""
import sys
...
def is_attacking(pos0, pos1):
    """Checking the positions of two queens are in an attacking mode.
...
def group_exists(group):
    """Checking a group exists in the list of solutions.
...
def build_solution(row, group):
    """Building solutions for the n queens problem.
...
def get_solutions():
    """Geting solutions for the given chessboard size.
    """
    global pos, n
